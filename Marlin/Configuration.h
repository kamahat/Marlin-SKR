...
#define STRING_CONFIG_H_AUTHOR "(Yoyo, Yoyo-config)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1 // recommande BTT -1

/**
 * Select a secondary serial port on the board to use for communication with the host.
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 1 // recommande BTT 0 ; Wifi 6 ; 1 SPI TFT
...
#define MACHINE_UUID "e4f82ea5-0407-4311-9302-7e2917e262d3"
 ...
 */
#define TEMP_SENSOR_0 5       //semitec 104GT-2 [0-300°C]
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Custom 2020-05-10 mosquitto 24V/40W
  #define DEFAULT_Kp 26.43
  #define DEFAULT_Ki 2.46
  #define DEFAULT_Kd 66.07
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 24.07
  #define DEFAULT_bedKi 1.45
  #define DEFAULT_bedKd 265.73
...
#define MIN_PROBE_EDGE 2 + ProbeDiameter/2
...
#define Z_CLEARANCE_BETWEEN_PROBES  Z_CLEARANCE_DEPLOY_PROBE // Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     Z_CLEARANCE_DEPLOY_PROBE // Z Clearance between multiple probes
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_LED_INDEX  12               // Index of the LED to use
